...
exports.getMonthNumber = exports.calculateFirstDate = exports.createDatesBetween = exports.getFirstDateInMonths = exports.months = exports.JAPAN_TIME_DIFF = exports.days = void 0;
...
function calculateFirstDate(from, day, time) {
    ...
    date.setDate(date.getDate() + ((getDayNumber(day) - date.getUTCDay() + 7) % 7));
