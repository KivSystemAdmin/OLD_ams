...
exports.getUnavailabilities = exports.updateRecurringAvailabilityInterval = exports.terminateRecurringAvailability = exports.getInstructorWithRecurringAvailabilityDay = exports.getInstructorByEmail = exports.getValidRecurringAvailabilities = exports.fetchInstructorAvailabilities = exports.deleteInstructorAvailability = exports.addInstructorAvailabilities = exports.getInstructorRecurringAvailabilities = exports.getInstructorWithRecurringAvailability = exports.addInstructorRecurringAvailability = exports.getInstructorById = exports.getAllInstructorsAvailabilities = exports.getAllInstructors = exports.createInstructor = void 0;
const prismaClient_1 = require("../../prisma/prismaClient");
const client_1 = require("@prisma/client");
// Create a new instructor account in the DB
const createInstructor = (instructorData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getAllInstructorsAvailabilities = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield prismaClient_1.prisma.instructor.findMany({
...
function addInstructorRecurringAvailability(instructorId_1, startAt_1) {
    return __awaiter(this, arguments, void 0, function* (instructorId, startAt, tx = prismaClient_1.prisma) {
        try {
...
exports.getInstructorWithRecurringAvailability = getInstructorWithRecurringAvailability;
...
exports.getInstructorRecurringAvailabilities = getInstructorRecurringAvailabilities;
function addInstructorAvailabilities(tx, instructorId, recurringAvailabilities) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const unavailabilities = yield tx.instructorUnavailability.findMany({
                where: { instructorId },
            });
            const excludeDateTimes = new Set(unavailabilities.map(({ dateTime }) => dateTime.toISOString()));
            for (const recurringAvailability of recurringAvailabilities) {
                const { instructorRecurringAvailabilityId, dateTimes } = recurringAvailability;
...
function fetchInstructorAvailabilities(instructorId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const availabilities = yield prismaClient_1.prisma.instructorAvailability.findMany({
                where: {
                    instructorId,
                },
                select: {
            ...
            const availableDateTimes = availabilities.map((availability) => availability.dateTime);
...
const getValidRecurringAvailabilities = (instructorId, date) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const recurringAvailabilities = yield prismaClient_1.prisma.instructorRecurringAvailability.findMany({
...
exports.getInstructorWithRecurringAvailabilityDay = getInstructorWithRecurringAvailabilityDay;
function terminateRecurringAvailability(instructorId, instructorRecurringAvailabilityId, endAt, tx) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (associatedClass) {
                ...
                throw Error("Cannot delete a recurring availability with associated class.");
            }
...
function updateRecurringAvailabilityInterval(instructorRecurringAvailabilityId, startAt, endAt, tx) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield tx.instructorRecurringAvailability.update({
                where: { id: instructorRecurringAvailabilityId },
            ...
            console.error("Database Error:", error);
            throw new Error("Failed to update instructor recurring availability interval.");
        }
    });
}
exports.updateRecurringAvailabilityInterval = updateRecurringAvailabilityInterval;
