...
exports.registerSubscriptionController = exports.updateCustomerProfile = exports.getCustomerById = exports.getSubscriptionsByIdController = exports.getCustomersClasses = exports.logoutCustomer = exports.loginCustomer = exports.registerCustomer = void 0;
...
const getCustomersClasses = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Exclude the password from the response.
        const { password } = customer, customerWithoutPassword = __rest(customer, ["password"]);
...
const getSubscriptionsByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const customerId = parseInt(req.params.id);
    try {
        const subscriptions = yield (0, subscriptionsService_1.getSubscriptionsById)(customerId);
...
const getCustomerById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const customer = yield (0, customersService_1.fetchCustomerById)(customerId);
        if (!customer) {
            return res.status(404).json({ error: "Customer not found." });
        }
        res.json({ customer });
...
const updateCustomerProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const customer = yield (0, customersService_1.updateCustomer)(customerId, name, email, prefecture);
        res.status(200).json({
...
const registerSubscriptionController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const customerId = parseInt(req.params.id);
    ...
    try {
        ...
        const newSubscription = yield (0, subscriptionsService_1.createNewSubscription)(subscriptionData);
        if (!newSubscription) {
        ...
        for (let i = 0; i < weeklyClassTimes; i++) {
            const newRecurringClass = yield (0, recurringClassesService_1.createNewRecurringClass)(subscriptionId);
