...
exports.getAllCustomers = exports.updateCustomer = exports.fetchCustomerById = void 0;
const prismaClient_1 = require("../../prisma/prismaClient");
const fetchCustomerById = (customerId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateCustomer = (id, name, email, prefecture) => __awaiter(void 0, void 0, void 0, function* () {
    try {
