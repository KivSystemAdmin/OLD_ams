...
exports.checkDoubleBooking = exports.checkForChildrenWithConflictingClasses = exports.isInstructorBooked = exports.getExcludedClasses = exports.createClassesUsingRecurringClassId = exports.fetchInstructorClasses = exports.cancelClassById = exports.getClassesForCalendar = exports.countClassesOfSubscription = exports.updateClass = exports.getClassById = exports.checkIfChildHasCompletedClass = exports.checkIfChildHasBookedClass = exports.deleteClass = exports.createClass = exports.getClassesByCustomerId = exports.getAllClasses = void 0;
...
const getClassesByCustomerId = (customerId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const classes = yield prismaClient_1.prisma.class.findMany({
            where: { customerId },
            include: {
...
const createClass = (classData, childrenIds) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const checkIfChildHasBookedClass = (tx, childId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const checkIfChildHasCompletedClass = (tx, childId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
// Update/Edit a class
const updateClass = (classId, dateTime, instructorId, childrenIds, status, isRebookable) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedClass = yield prismaClient_1.prisma.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
...
const getClassesForCalendar = (userId, userType) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const includeOptions = {
            instructor: userType === "customer",
            classAttendance: { include: { children: true } },
        };
        const whereCondition = userType === "instructor"
            ? { instructorId: userId }
            : { customerId: userId };
        const classes = yield prismaClient_1.prisma.class.findMany({
...
// Cancel a class
const cancelClassById = (classId, isPastPrevDayDeadline) => __awaiter(void 0, void 0, void 0, function* () {
...
const fetchInstructorClasses = (instructorId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const classes = yield prismaClient_1.prisma.class.findMany({
            where: { instructorId },
            include: {
...
const createClassesUsingRecurringClassId = (tx, recurringClassId, instructorId, customerId, subscriptionId, childrenIds, dateTimes) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getExcludedClasses = (tx, recurringClassIds, date) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const isInstructorBooked = (instructorId, dateTime) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const checkForChildrenWithConflictingClasses = (dateTime, childrenIds) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const childrenWithConflictingClasses = conflictingClasses.flatMap((eachClass) => eachClass.classAttendance
...
exports.checkForChildrenWithConflictingClasses = checkForChildrenWithConflictingClasses;
// Check if there is a class that is already booked at the same dateTime as the newlly booked class
const checkDoubleBooking = (customerId, dateTime) => __awaiter(void 0, void 0, void 0, function* () {
    try {
