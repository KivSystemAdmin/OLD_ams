...
exports.getValidRecurringClassesByInstructorId = exports.createNewRecurringClass = exports.getValidRecurringClasses = exports.deleteRecurringClass = exports.getRecurringClassByRecurringClassId = exports.terminateRecurringClass = exports.getRecurringClassesBySubscriptionId = exports.addRecurringClass = void 0;
const prismaClient_1 = require("../../prisma/prismaClient");
// Create a new recurring class in the DB
const addRecurringClass = (tx, instructorId, customerId, childrenIds, subscriptionId, startAt, dateTimes, endAt) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getRecurringClassesBySubscriptionId = (subscriptionId, date) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const recurringClasses = yield prismaClient_1.prisma.recurringClass.findMany({
            where: {
                subscriptionId,
...
exports.getRecurringClassesBySubscriptionId = getRecurringClassesBySubscriptionId;
// Update the end date to the recurring class.
const terminateRecurringClass = (tx, recurringClassId, endAt) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getRecurringClassByRecurringClassId = (tx, recurringClassId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getRecurringClassByRecurringClassId = getRecurringClassByRecurringClassId;
// Delete the recurring class.
const deleteRecurringClass = (tx, recurringClassId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getValidRecurringClasses = (tx, date) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const createNewRecurringClass = (subscriptionId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newRecurringClass = yield prismaClient_1.prisma.recurringClass.create({
            data: {
                instructorId: null,
...
const getValidRecurringClassesByInstructorId = (instructorId, date) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const recurringClasses = yield prismaClient_1.prisma.recurringClass.findMany({
...
exports.getValidRecurringClassesByInstructorId = getValidRecurringClassesByInstructorId;
