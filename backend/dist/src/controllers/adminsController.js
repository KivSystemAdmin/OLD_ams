...
exports.getAllChildrenController = exports.registerInstructorController = exports.getAllInstructorsController = exports.getAllCustomersController = exports.registerAdminController = exports.logoutAdminController = exports.loginAdminController = void 0;
...
const registerAdminController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const admin = yield (0, adminsService_1.createAdmin)({ name, email, password: hashedPassword });
...
const getAllCustomersController = (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const registerInstructorController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, email, password, nickname, icon, classURL, meetingId, passcode, introductionURL, } = req.body;
    try {
        // Hash the password.
        const hashedPassword = yield bcrypt_1.default.hash(password, saltRounds);
        ...
        // Exclude the password from the response.
        if (instructor) {
            const { password: _ } = instructor, instructorWithoutPassword = __rest(instructor, ["password"]);
            res.status(200).json({
...
// Admin dashboard for displaying instructors' information
const getAllChildrenController = (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = children.map((child, number) => {
            ...
            return {
                ...
                Birthdate: birthdate === null || birthdate === void 0 ? void 0 : birthdate.toISOString().slice(0, 10),
