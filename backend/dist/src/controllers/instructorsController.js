...
exports.logoutInstructorController = exports.loginInstructorController = exports.getRecurringAvailabilityById = exports.getAllInstructorsController = exports.getInstructorAvailabilities = exports.deleteAvailability = exports.addAvailability = exports.RecurringAvailability = exports.getInstructor = exports.getAllInstructorsAvailabilitiesController = void 0;
...
const getAllInstructorsAvailabilitiesController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { day, time, from } = req.query;
    if (day && time && from) {
        const instructors = yield searchInstructorsUsingRecurringAvailability(day, time, from);
        return res.status(200).json({ instructors });
    }
    try {
        // Fetch the instructors and their availabilities data from the DB
        const instructors = yield (0, instructorsService_1.getAllInstructorsAvailabilities)();
        ...
        const data = instructors.map((instructor) => (0, commonUtils_1.pickProperties)(instructor, selectedProperties, propertyMapping));
        res.json({ data });
    }
    catch (error) {
...
exports.getAllInstructorsAvailabilitiesController = getAllInstructorsAvailabilitiesController;
...
function searchInstructorsUsingRecurringAvailability(day, time, from) {
    return __awaiter(this, void 0, void 0, function* () {
        const firstDate = (0, dateUtils_1.calculateFirstDate)(new Date(from), day, time);
...
const getInstructor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
(function (RecurringAvailability) {
    ...
    RecurringAvailability.get = (req, res) => __awaiter(this, void 0, void 0, function* () {
        if (!req.query.date) {
        ...
        date.setSeconds(-1);
        const instructor = yield callServiceWithoutException(() => (0, instructorsService_1.getInstructorWithRecurringAvailability)(req.id));
        if (!instructor) {
            return res.status(404).json({ message: "Instructor not found." });
        }
    ...
    RecurringAvailability.put = (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield prismaClient_1.prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
            const recurrings = (yield (0, instructorsService_1.getInstructorWithRecurringAvailabilityDay)(req.id, tx));
            for (const { id, startAt, endAt, day, time } of recurrings) {
                const isIncludedInNewSchedule = slotsOfDays[day].some((slot) => slot === time);
                if (!isIncludedInNewSchedule) {
                    const end = maxDate(startAt, newEndAt);
                    tasks.push((0, instructorsService_1.terminateRecurringAvailability)(req.id, id, end, tx));
                    continue;
                }
                const newStartAt = (0, dateUtils_1.calculateFirstDate)(startDate, day, time);
                if (endAt && endAt < newStartAt) {
                    // startAt  endAt  newStartAt
                    // |---------|      |----------
                    tasks.push((0, instructorsService_1.addInstructorRecurringAvailability)(req.id, newStartAt, tx));
                }
                ...
                tasks.push((0, instructorsService_1.updateRecurringAvailabilityInterval)(id, start, null, tx));
            }
            ...
            dateUtils_1.days.forEach((day) => {
                slotsOfDays[day]
                    ...
                    const existsInDb = recurrings.some((a) => a.day === day && a.time === time);
                    return !existsInDb;
                })
                    .forEach((time) => __awaiter(this, void 0, void 0, function* () {
                    const startAt = (0, dateUtils_1.calculateFirstDate)(startDate, day, time);
                    tasks.push((0, instructorsService_1.addInstructorRecurringAvailability)(req.id, startAt, tx));
                }));
            });
...
})(RecurringAvailability || (exports.RecurringAvailability = RecurringAvailability = {}));
...
function addAvailabilityInternal(tx, instructorId, from, until) {
    return __awaiter(this, void 0, void 0, function* () {
        const recurringAvailabilities = yield (0, instructorsService_1.getInstructorRecurringAvailabilities)(tx, instructorId);
        ...
        const dateTimes = recurringAvailabilities.map(({ id, startAt: startAtStr, endAt: endAtStr }) => {
        ...
        const unavailabilities = (yield (0, instructorsService_1.getUnavailabilities)(instructorId)).map(({ dateTime }) => dateTime);
        dateTimes.forEach((dateTimes) => {
            dateTimes.dateTimes = dateTimes.dateTimes.filter((dateTime) => !unavailabilities.includes(dateTime));
        });
        yield (0, instructorsService_1.addInstructorAvailabilities)(tx, instructorId, dateTimes);
    });
}
const deleteAvailability = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const availability = yield (0, instructorsService_1.deleteInstructorAvailability)(req.id, dateTime);
    return res.status(200).json({ availability });
});
exports.deleteAvailability = deleteAvailability;
const getInstructorAvailabilities = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const instructorAvailabilities = yield (0, instructorsService_1.fetchInstructorAvailabilities)(req.id);
...
const getAllInstructorsController = (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getRecurringAvailabilityById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Get the local date and the end of its time.
    const today = new Date();
    today.setUTCHours(23, 59, 59, 0);
    today.setDate(today.getDate());
    try {
        const recurringAvailabilities = yield (0, instructorsService_1.getValidRecurringAvailabilities)(req.id, today);
...
// Login Instructor
const loginInstructorController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const instructor = yield (0, instructorsService_1.getInstructorByEmail)(email);
        if (!instructor) {
        ...
        const result = yield bcrypt_1.default.compare(password, instructor.password);
        if (!result) {
            return res.status(401).json({
...
const logoutInstructorController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
