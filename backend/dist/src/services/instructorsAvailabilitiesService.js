...
const fetchInstructorAvailabilitiesTodayAndAfter = (instructorId, startDate) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const excludedFromUnavailability = yield prismaClient_1.prisma.instructorUnavailability.findMany({
            where: {
                instructorId: instructorId,
                dateTime: {
                    gte: startDate,
        ...
        const dateTimes = availabilities.map((availability) => availability.dateTime);
        return dateTimes;
    }
    catch (error) {
...
exports.fetchInstructorAvailabilitiesTodayAndAfter = fetchInstructorAvailabilitiesTodayAndAfter;
